...
void Clock::show(uint8_t hours,uint8_t minutes, uint32_t color) {
    showStringOnClock(timeToString(hours,minutes), color);
 ...
 */
void Clock::drawMinuteIndicator(uint8_t minutes, uint32_t color){
 ...
 */
int Clock::showStringOnClock(String message, uint32_t color){
    int messageStart = 0;
    String word = "";
 ...
 */
String Clock::timeToString(uint8_t hours,uint8_t minutes){
